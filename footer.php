...
<footer>
    ...
    <div class="tp-footer-area tp-footer-overly position-relative pt-130 tp-bg-mulberry">
        <?php
        $footer_bg_image = "<?php echo get_template_directory_uri(); ?>/assets/img/update/footer/footer.jpg";
        if (!empty($footer_bg_image)): ?>
            <div class="tp-footer-bg">
                <img src="<?php echo $footer_bg_image; ?> " alt="">
            </div>
        <?php endif; ?>
        <div class="container container-1424">
            <div class="row pb-60">
                ...
                <div class="col-xxl-3 col-xl-2 col-lg-6 col-md-6 col-sm-6">
                    <?php dynamic_sidebar('footer-3-widget-3') ?>
                </div>
